...
const About = () => {
  return (
    <div className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">
      ...
      <section className="py-24 px-6 bg-gray-100">
        <div className="mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="group flex items-start gap-6 p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all">
              <div className="flex w-32 p-4 items-center justify-center rounded-xl bg-blue-100 text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-all">
                <span className="material-symbols-outlined text-3xl"><Eye size={40} /></span>
              </div>
            ...
            <div className="relative z-10">
              <div className="aspect-square overflow-hidden rounded-3xl bg-slate-200 shadow-2xl z-10">
                <img
              ...
              <div className="absolute -bottom-9 -left-6 h-48 w-48 rounded-2xl bg-blue-100 border-4 border-white dark:border-slate-900 z-[-1]"></div>
              <div className="absolute -top-6 -right-6 h-48 w-48 rounded-2xl bg-slate-100 border-4 border-white dark:border-slate-900 z-[-1]"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Why Choose Us */}
      <section className="bg-white dark:bg-slate-950 py-24 px-6 border-y border-slate-100 dark:border-slate-800">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-gray-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-6 hover:-translate-y-2 transition-transform">
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Monitor every shipment with live updates
                across all partners through our unified
                tracking interface. Stay informed at every
                step.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-gray-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-6 hover:-translate-y-2 transition-transform">
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Connect with 50+ global logistics providers in
                one single dashboard. Manage contracts and
                carriers with absolute ease.
              </p>
            </div>

            <div className="p-8 rounded-2xl bg-gray-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-6 hover:-translate-y-2 transition-transform">
              <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-white dark:bg-slate-800 shadow-md">
                <span className="material-symbols-outlined text-blue-600 text-3xl">
                  <Banknote size={40} />
                </span>
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Save up to 30% on shipping costs with our
                smart comparison engine that finds the best
                rates based on your specific route.
              </p>
            </div>
          </div>
        </div>
